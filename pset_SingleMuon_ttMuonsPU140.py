...
process.RandomNumberGeneratorService.generator.initialSeed =random.randint(0,10000000)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleMuon_tt27_%s.root' %sys.argv[2]),
...
process.mix.input.fileNames = cms.untracked.vstring(['file:/fdata/hepx/store/user/rish/MinBias/MinBias_TuneZ2star_GEN_SIM_%d.root' %random.randint(1,999)])
